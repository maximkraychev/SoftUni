...
function roadRadar(speed, area) {
    ...
    if (speed <= allAreas[area]) {
        console.log(`Driving ${speed} km/h in a ${allAreas[area]} zone`);
    } else {
        const difference = speed - allAreas[area];
        let status = '';
        ...
        console.log(`The speed is ${difference} km/h faster than the allowed speed of ${allAreas[area]} - ${status}`);
    }
}
